...
foreach(project_source_file IN LISTS project_source_files)
    ...
    foreach(forbidden_marker IN ITEMS
        ...
        if(NOT marker_index EQUAL -1)
            message(FATAL_ERROR "Project-owned source contains forbidden wxGLContext path marker '${forbidden_marker}': ${project_source_file}")
        endif()
    endforeach()
endforeach()

message(STATUS "Verified no project-owned wxGLContext drawing paths under include/ and src/")
